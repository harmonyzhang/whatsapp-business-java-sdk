...
public class Example {
    ...
    public Example addHeaderHandleExample(String... example) {
        ...
        if (example != null) this.headerHandle.addAll(Arrays.stream(example).collect(Collectors.toList()));
        return this;
    }
    ...
    public Example addHeaderTextExample(String... example) {
        ...
        if (example != null) this.headerText.addAll(Arrays.stream(example).collect(Collectors.toList()));
        return this;
    }
    ...
    public Example addBodyTextExamples(String... example) {
        ...
        if (example != null) bodyText.add(Arrays.stream(example).collect(Collectors.toList()));
        return this;
    }
}
