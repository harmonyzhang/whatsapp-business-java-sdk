...
public class WhatsappBusinessManagementApi {
    ...
    public MessageTemplates retrieveTemplates(String whatsappBusinessAccountId, int limit) {
        ...
        return executeSync(whatsappBusinessManagementApiService.retrieveTemplates(whatsappBusinessAccountId, filters));
    }
    ...
    public PhoneNumber retrievePhoneNumber(String phoneNumberId, String... fields) {
        ...
        Map<String, Object> filters = new HashMap<>();
        filters.put("fields", String.join(",", fields));
        return executeSync(whatsappBusinessManagementApiService.retrievePhoneNumber(phoneNumberId, filters));
    }
