...
public class WhatsappApiServiceGenerator {
    ...
    public static <S> S createService(Class<S> serviceClass, String token, String baseUrl) {
        if (token == null) {
            return createServiceBase(serviceClass, baseUrl, null);
        } else {
            return createServiceBase(serviceClass, baseUrl, new AuthenticationInterceptor(token));
        }
    }
     ...
     * @return the s
     */
    public static <S> S createServiceBasic(Class<S> serviceClass, String token, String baseUrl) {
        if (token == null) {
            return createServiceBase(serviceClass, baseUrl, null);
        } else {
            return createServiceBase(serviceClass, baseUrl, new BasicAuthenticationInterceptor(token));
        }
    }
