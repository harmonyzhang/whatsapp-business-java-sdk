...
public interface WhatsappBusinessManagementApiService {
     ...
     * @return the call
     */
    @POST("/" + WhatsappApiConfig.API_VERSION + "/{whatsapp-business-account-ID}/message_templates")
     ...
     * @return the call
     */
    @POST("/" + WhatsappApiConfig.API_VERSION + "/{whatsapp-business-account-ID}/message_templates/{message-template-id}")
     ...
     * @return the call
     */
    @DELETE("/" + WhatsappApiConfig.API_VERSION + "/{whatsapp-business-account-ID}/message_templates")
     ...
     * @return the call
     */
    @GET("/" + WhatsappApiConfig.API_VERSION + "/{whatsapp-business-account-ID}/message_templates")
     ...
     * @return the call
     */
    @GET("/" + WhatsappApiConfig.API_VERSION + "/{phone-number-ID}")
     ...
     * @return the call
     */
    @GET("/" + WhatsappApiConfig.API_VERSION + "/{whatsapp-business-account-ID}/phone_numbers")
     ...
     * @return the call
     */
    @POST("/" + WhatsappApiConfig.API_VERSION + "/{phone-number-ID}/request_code")
     ...
     * @return the call
     */
    @POST("/" + WhatsappApiConfig.API_VERSION + "/{phone-number-ID}/verify_code")
